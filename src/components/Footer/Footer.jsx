    ...
    <div className='Footer'>
      ...
      <div className='Footer__logo'>
        <a href='https://github.com/UdotBdot' target='_blank'>
          <img width="28" height="28" className="Footer__logos" src="../../images/Logos/github_logo.webp" alt="GitHub Logo" />
        </a>
        <a href="https://www.linkedin.com/in/frederic-sin-965b36100/" target='_blank'>
          <img width="28" height="28" className="Footer__logos" src="../../images/Logos/Linkedin.png" alt="LinkedIn Logo" />
        </a>
      </div>
    </div>
    )}
